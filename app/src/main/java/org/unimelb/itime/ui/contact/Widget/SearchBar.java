...
import org.unimelb.itime.ui.contact.Beans.SizeCollector;
...
public class SearchBar extends LinearLayout {
    ...
    public void initSearchButton(){
        ...
        searchButton.setBackground(getResources().getDrawable(R.drawable.corner_boarder));
        ...
        LayoutParams iconParams = new LayoutParams(SizeHelper.dp2px(getContext(),15),
                SizeHelper.dp2px(getContext(),15));
        iconParams.setMargins(SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10));
...
//                SizeHelper.dp2px(getContext(),10));
        ...
        editTextLayout.setBackground(getResources().getDrawable(R.drawable.corner_boarder));
        ...
        inputTextParams.setMargins(0,0, SizeHelper.dp2px(getContext(),10),0);
        ...
        LinearLayout.LayoutParams inputViewParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        inputViewParams.setMargins(SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10));
        ...
        cancelButtonParams.setMargins(SizeHelper.dp2px(getContext(),10),
                SizeHelper.dp2px(getContext(),10),
                0,
                SizeHelper.dp2px(getContext(),10));
