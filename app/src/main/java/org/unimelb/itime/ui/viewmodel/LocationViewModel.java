...
public class LocationViewModel extends CommonViewModel {
    ...
    private String searchViewInputText;
...
//
//    public SearchBar.InputTextChangedListener onSearching(){
//        return new SearchBar.InputTextChangedListener(this.get, this) {
//            @Override
//            public void onEditing(View view, String text) {
//                presenter.getFilter().filter(text);
//            }
...
//    }
    ...
    @Bindable
    public String getSearchViewInputText() {
        return searchViewInputText;
    }

    public void setSearchViewInputText(String searchViewInputText) {
        this.searchViewInputText = searchViewInputText;
        notifyPropertyChanged(BR.searchViewInputText);
    }
