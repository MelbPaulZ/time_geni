...
public class LocationPresenter<V extends TaskBasedMvpView<AutocompletePrediction>>
        extends MvpBasePresenter<V> implements Filterable{
    ...
    public void setPlaceAutoCompleteAdapter(PlaceAutoCompleteAdapter adapter){
    ...
    public static class PlaceAutoCompleteAdapter
        ...
        private LocationPickerMvpView mvpView;
        /**
        ...
        public void setMvpView(LocationPickerMvpView mvpView) {
            ...
            return new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    if (results != null && results.count > 0) {
                        ...
                        if (mvpView!=null){
                            mvpView.onFilterLocations(mResultList);
                        }
...
//        protected void publishResults(CharSequence constraint, FilterResults results) {
//            if(getView() != null){
//                getView().onFilterLocations((List<String>) results.values);
//            }
//        }
//    }
}
