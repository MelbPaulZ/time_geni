...
package org.unimelb.itime.widget.QRCode.utils;
...
public class CaptureActivityHandler extends Handler {
    ...
    private final CaptureActivityContact activity;
    private final DecodeThread decodeThread;
    private final CameraManager cameraManager;
    private State state;

    public CaptureActivityHandler(CaptureActivityContact activity, CameraManager cameraManager, int decodeMode) {
